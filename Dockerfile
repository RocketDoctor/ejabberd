...
# Configure database via env for SQL Proxy on host
ENV EJABBERD_DB_TYPE=pgsql \
    EJABBERD_DB_HOST=${EJABBERD_DB_HOST:-127.0.0.1} \
    EJABBERD_DB_PORT=${EJABBERD_DB_PORT:-5432} \
    EJABBERD_DB_USER=${EJABBERD_DB_USER:-ejabberd} \
    EJABBERD_DB_PASSWORD=${EJABBERD_DB_PASSWORD:-change_me} \
    EJABBERD_DB_NAME=${EJABBERD_DB_NAME:-ejabberd}
